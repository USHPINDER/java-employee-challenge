...
import com.reliaquest.api.constants.*;
...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public Employee getEmployeeById(String id) {
		...
		Mono<com.example.rqchallenge.dtos.EmployeeByIdResponseDTO> employeeMono = webClient.get()
				.uri(Constants.REST_API_URI_GET_EMPLOYEE_BY_ID + id).retrieve()
				.bodyToMono(com.example.rqchallenge.dtos.EmployeeByIdResponseDTO.class);
	...
	public Object createEmployee(Map<String, Object> employeeInput) {
		...
		Object employeeMono = webClient.post().uri(Constants.REST_API_URI_CREATE_EMPLOYEE)
	...
	public Object deleteEmployee(String id) {
		...
		Object employeeMono = webClient.delete().uri(Constants.REST_API_URI_DELETE_EMPLOYEE + id)
